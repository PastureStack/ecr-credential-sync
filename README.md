...
ghcr.io/pasturestack/ecr-credential-sync:v3.1.5
```
...
```bash
VERSION_OVERRIDE=v3.1.5 ARCH=amd64 make build
VERSION_OVERRIDE=v3.1.5 ARCH=amd64 make test
```
